...
<html>
	...
	<title>&mdash;Gimnasio Home Gym</title>
	...
	<nav class="fh5co-nav" role="navigation">
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 text-right">
						<p class="num">llamar: 68146005</p>
						<ul class="fh5co-social">
							<li><a href="#"><i class="icon-twitter"></i></a></li>
							<li><a href="#"><i class="icon-dribbble"></i></a></li>
							<li><a href="#"><i class="icon-github"></i></a></li>
						</ul>
						<button class="secondary_btn" type="button" id="login_toggle" onclick="showLogin()">
								<span class="far fa-lg fa-user" aria-hidden="true"></span>
								<a href="modulo_login2.php">Iniciar Sesion</a>
						</button>
					</div>
				</div>
			</div>
		...
		<div class="top-menu">
			<div class="container">
				<div class="row">
					<div class="col-xs-2">
						<div id="fh5co-logo"><a href="index.html">Home Gym<span>.</span></a></div>
					</div>
					<div class="col-xs-10 text-right menu-1">
						<ul>
							<li class="active"><a href="index.html">Inicio</a></li>
							<li><a href="gallery.html">Galeria</a></li>
							<li><a href="about.html">Entrenador</a></li>
				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							<h1>Hazlo tu estilo de vida, no una obligación</h1>
							<h2> <a href="http://freehtml5.co/" target="_blank"></a></h2>
							<p><a href="https://vimeo.com/channels/staffpicks/93951774" class="btn btn-primary popup-vimeo">Mira nuestro video</a></p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-4 text-center animate-box">
					<div class="services">
						...
						<p>Debes hacer lo que otros no hacen, para lograr lo que otros tendran</p>
						<p><a href="#" class="btn btn-primary btn-outline btn-sm">ver mas... <i class="icon-arrow-right"></i></a></p>
					</div>
				</div>
				<div class="col-md-4 text-center animate-box">
					<div class="services">
						...
						<h3>Caminadoras</h3>
						<p>Corre tras tus sueños si no los alcanzas al menos haces deporte</p>
						<p><a href="#" class="btn btn-primary btn-outline btn-sm">ver mas... <i class="icon-arrow-right"></i></a></p>
					</div>
				</div>
				<div class="col-md-4 text-center animate-box">
					<div class="services">
						...
						<h3>Yoga</h3>
						<p>Todo lo que sucede en tu vida es para que despiertes tu conciencia y avances en tu evolucion</p>
						<p><a href="#" class="btn btn-primary btn-outline btn-sm">ver mas... <i class="icon-arrow-right"></i></a></p>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<h2>Experto en Fitness</h2>
					<p>Queda extrictamente prohibido rendirse.</p>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-4 col-sm-4 animate-box">
					<div class="trainer">
						...
						<div class="title">
							...
							<span>Experto en el moldeado del cuerpo</span>
						</div>
						<div class="desc text-center">
							<ul class="fh5co-social-icons">
								<li><a href="#"><i class="icon-twitter"></i></a></li>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					...
					<p>Para ganar mas dinero no debes trabajar mas, debes tener mejores ideas</p>
				</div>
			</div>
			<div class="row">
				<div class="pricing">
					<div class="col-md-3 animate-box">
						<div class="price-box">
							<h2 class="pricing-plan">Horas</h2>
							<div class="price"><sup class="currency">Bs</sup>9<small></small></div>
							<ul class="classes">
								<li>15 Cases de Cardio</li>
							...
							<a href="#" class="btn btn-select-plan btn-sm">Selecciona tu plan...</a>
						</div>
					</div>

					<div class="col-md-3 animate-box">
						<div class="price-box">
							<h2 class="pricing-plan">Dias</h2>
							<div class="price"><sup class="currency">Bs</sup>27<small></small></div>
							<ul class="classes">
					...
					<div class="col-md-3 animate-box">
						<div class="price-box popular">
							<h2 class="pricing-plan pricing-plan-offer">Semanal <span>La mejor oferta</span></h2>
							<div class="price"><sup class="currency">Bs</sup>74<small></small></div>
							<ul class="classes">
								<li>15 Cardio Classes</li>
								<li class="color">10 Swimming Lesson</li>
								<li>10 Yoga Classes</li>
					...
					<div class="col-md-3 animate-box">
						<div class="price-box">
							<h2 class="pricing-plan">Mensual</h2>
							<div class="price"><sup class="currency">Bs</sup>140<small></small></div>
							<ul class="classes">
								<li>15 Cardio Classes</li>
								<li class="color">10 Swimming Lesson</li>
								<li>10 Yoga Classes</li>
